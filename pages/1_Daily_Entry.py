...
customer_names_list = [c["name"] for c in all_customers]

customer_search = st.text_input(
    "Type to search customers", key="customer_search", label_visibility="collapsed",
    placeholder="Start typing a customer name..."
)

filtered_customer_names = [
    name for name in customer_names_list
    if customer_search.lower() in name.lower()
] if customer_search else customer_names_list

if filtered_customer_names:
    selected_customer_name = st.selectbox(
        "Existing customers — click to fill",
        [""] + sorted(set(filtered_customer_names)),
        key="customer_select",
    ...
    st.session_state.customer_name = customer_search
